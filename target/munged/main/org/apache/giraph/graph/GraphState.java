...
E extends Writable, M extends Writable> {
  ...
  //added to support Giraph++
  private Partition<I,V,E,M> currentPartition=null;
  public Partition<I,V,E,M> getCurrentPartition()
  {
	  return currentPartition;
  }
  public void setCurrentPartition(Partition<I,V,E,M> part)
  {
