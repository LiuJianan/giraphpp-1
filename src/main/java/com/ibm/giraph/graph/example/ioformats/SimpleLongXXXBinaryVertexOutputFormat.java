...
public class SimpleLongXXXBinaryVertexOutputFormat<V extends Writable, E extends Writable, NeighborhoodType extends Neighborhood<LongWritable, V, E>> 
extends VertexOutputFormat<LongWritable, V, E>{

	private static final Logger LOG = Logger.getLogger(SimpleLongXXXBinaryVertexOutputFormat.class);
